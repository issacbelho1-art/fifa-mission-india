...
/* =========================================================
   FIFA MISSION INDIA - COACH REGISTRATION
   Frontend only
========================================================= */
...
const coachingAchievements = document.getElementById(
...
const achievementCharacterCount = document.getElementById(
  "achievementCharacterCount"
);
...
const coachingCertificate = document.getElementById(
  "coachingCertificate"
);
...
const coachingCertificateName = document.getElementById(
  "coachingCertificateName"
);
...
function validateField(field) {
  ...
  if (
    ...
    setFieldError(
      field,
      "Write at least 50 characters about your coaching philosophy."
    );
...
coachBio.addEventListener("input", () => {

  bioCharacterCount.textContent =
    coachBio.value.length;

});


coachingAchievements.addEventListener("input", () => {

  achievementCharacterCount.textContent =
    coachingAchievements.value.length;
...
coachingCertificate.addEventListener("change", () => {
...
function populateReviewSection() {
  ...
  document.getElementById(
    ...
    getSelectedText("highestLicence") || "—";
  ...
  document.getElementById(
    ...
    document
      .getElementById("currentOrganisation")
      .value
      .trim() || "Not provided";
